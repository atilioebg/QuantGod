...
- **Execução**: `python -m cloud.pre_processamento.orchestration.run_pipeline`
...
- **Execução**: `python cloud/labelling/run_labelling.py`
...
- **Execução**: `python cloud/otimizacao/run_optuna.py`
...
- **Execução**: `python cloud/treino/run_training.py`

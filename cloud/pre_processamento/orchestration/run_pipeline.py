...
import pandas as pd
from cloud.pre_processamento.etl.extract import DataExtractor
from cloud.pre_processamento.etl.transform import L2Transformer
from cloud.pre_processamento.etl.load import DataLoader
from cloud.pre_processamento.etl.validate import DataValidator
import json
...
def run_pipeline():
    ...
    if len(sys.argv) > 1:
        ...
        config_path = Path("cloud/pre_processamento/configs/cloud_config.yaml")
